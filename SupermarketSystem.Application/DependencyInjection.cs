...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<SetProductBranchAvailabilityHandler>();
        services.AddScoped<CreatePromotionHandler>();
        services.AddScoped<UpdatePromotionHandler>();
        services.AddScoped<SetPromotionBranchActiveHandler>();
        services.AddScoped<GetProductPromotionsHandler>();
        services.AddScoped<CreateExpenseHandler>();
        services.AddScoped<GetExpensesHandler>();
        services.AddScoped<CreateCapitalTransactionHandler>();
        services.AddScoped<GetCapitalTransactionsHandler>();
        services.AddScoped<GetMonthlyProfitStatementHandler>();
