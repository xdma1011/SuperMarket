...
///
/// الأثر فوري: ActiveSessionValidator (Infrastructure) بيفحص الجلسة بكل طلب،
/// فتوكن الوصول الحالي بينرفض (401) من الطلب الجاي، مش بعد انتهاء عمره.
///
/// ملاحظة نطاق: هذا يبطل جلسة *واحدة محدَّدة*. إلغاء كل جلسات مستخدم بيصير
/// ضمن تعطيله نفسه (UpdateUserHandler).
/// </summary>
