...
public static class InvoiceOcrPrompt
{
    public const string Text = """
          ...
          "items": [
            {
              ...
              "unitCost": <سعر الوحدة *النهائي* شامل الضريبة - المبلغ الفعلي المطلوب دفعه لكل وحدة>,
              "lineTotal": <إجمالي السطر *النهائي* شامل الضريبة إذا ظهر، وإلا null>
            }
          ],
          "invoiceTotal": <الإجمالي الكلي *النهائي* المطلوب دفعه فعليًا (شامل الضريبة إن وُجدت)، وإلا null>,
        ...
        - كل الأسعار (unitCost وlineTotal وinvoiceTotal) لازم تكون السعر *النهائي* كما سيُدفع فعليًا - لا تفصل الضريبة ولا تطرحها. لو الفاتورة عارضة عمودين (سعر قبل الضريبة وسعر بعدها)، خذ العمود النهائي/الصافي (بعد الضريبة) دائمًا، مهما كان اسمه بالفاتورة (شامل، صافي، إجمالي، Net، Total...).
